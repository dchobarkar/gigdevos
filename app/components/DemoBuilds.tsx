  ...
  return (
    <section id="demos" className="relative py-24 px-6 grid-overlay">
      <div className="mx-auto max-w-6xl">
        ...
        >
          Self-initiated projects that show what I can build. Live links and
          repos when available.
        </motion.p>
          ...
          {DEMOS.map((demo, i) => (
            ...
            >
              <div className="aspect-5/3 bg-card border-b border-border flex items-center justify-center">
                <div className="w-full h-full bg-linear-to-br from-(--border)/30 to-card flex items-center justify-center">
